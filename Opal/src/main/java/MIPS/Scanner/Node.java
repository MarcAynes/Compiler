...
public class Node implements trieIntMips {
    public Object pare;
    public int altura;
    ...
    public void addLetter(char[] lletra, int i, Object aiudame) {
        ...
        if (lletra.length == i) {
            ...
            if (lletres[lletra[i]] == null) {
                lletres[lletra[i]] = new MIPS.Scanner.Node();
            }
    ...
    public MIPS.Scanner.Return search(char[] paraula, int posicio, Return retorna) {
    ...
    public Boolean elimina(char[] paraula, int posicio) {
        ...
        if  (owisim) {
            ...
            if (!owo) {
                if (pare instanceof trieIntMips) {
                    ((trieIntMips) pare).EliminaFill(this);
                }
            }
        }
        return owisim;
    ...
    @Override
    public void EliminaFill(MIPS.Scanner.Node fill) {
        for (int i = 0; 255 > i; i++) {
