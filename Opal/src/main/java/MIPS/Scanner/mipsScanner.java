...
public class mipsScanner {
    int linia = 0;
    private MIPS.Scanner.Trie trie = new Trie();
    List<String> tokens = new ArrayList<>();
    private BufferedReader br;

    public mipsScanner(String file){
        ...
        try {
            Symbol[] sym = gson.fromJson(new FileReader("src/main/java/MIPS/Scanner/Symbols.json"), Symbol[].class);
