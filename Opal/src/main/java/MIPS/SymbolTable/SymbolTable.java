...
public class SymbolTable {
    ...
    HashMap<String, MIPS.SymbolTable.Symbol> Table = new HashMap<String, MIPS.SymbolTable.Symbol>();

    public SymbolTable(String file){

        Gson gson = new Gson();
        try {
            MIPS.SymbolTable.Symbol[] sym = gson.fromJson(new FileReader(file), MIPS.SymbolTable.Symbol[].class);
    ...
    public MIPS.SymbolTable.Symbol search(String s){

        return this.Table.get(s);
    }

    public boolean add(MIPS.SymbolTable.Symbol s){
    ...
    public boolean delete(MIPS.SymbolTable.Symbol s){
